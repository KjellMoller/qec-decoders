...
# Source: adapted from https://github.com/quantumgizmos/ldpc/blob/main/src_python/ldpc/sinter_decoders/sinter_bposd_decoder.py

class SinterUnionFindDecoder(sinter.Decoder):
    """
    A sinter-compatible wrapper around ldpc's UnionFindDecoder.

    Parameters
    ----------
    uf_method : bool, optional
        Decoding mode for the Union-Find decoder, by default False.
        False = peeling decoder (faster, works well for sparse codes).
        True  = matrix-solve mode (more general).
    """

    def __init__(self, uf_method: bool = False):
    ...
    def decode(self, syndrome: np.ndarray) -> np.ndarray:
        corr = self.union_find.decode(syndrome)
